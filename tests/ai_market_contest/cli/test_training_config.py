...
def test_training_config(tmp_path):
    ...
    training_config_reader = TrainingConfigReader(tmp_path/"training_configs/training_example_config.ini", demand_function_locator, config_parser)

    assert training_config_reader.get_naive_agent_counts() == {'FixedFifty': 3, 'Random': 1}
