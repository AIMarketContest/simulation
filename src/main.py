...
plt.plot(list(range(len(price_points_agent1))), price_points_agent1, marker="o", color="pink")
plt.plot(list(range(len(price_points_agent2))), price_points_agent2, marker="o", color="blue")
