...
from ai_market_contest.graphing import create_agents, create_agent_profits_dict


def cumulative_profit_ranking(agent_profits: dict[Agent, List[float]]) -> List[(Agent, float)]:
