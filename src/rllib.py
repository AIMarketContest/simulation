...
env =Market(
        num_agents, demand_function(99), training_duration, agent_name_maker)
...
ps = PolicySelector("test-agent", self_play_number=num_self_play_agents, naive_agents_counts=naive_agents_counts)
config = {
    "num_workers": 0,
    "multiagent": {
